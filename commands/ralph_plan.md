...
0a. fetch the top 10 priority items from linear in status "Ready For Plan" using the MCP tools, noting all items in the `links` section
...
1. move the item to "In Plan" using the MCP tools
...
2b. move the item to "In Progress" using the MCP tools
...
Ticket moved to "In Progress" status
